...
public class Code4Life {
			...
			int numHoursCoded = Integer.parseInt(JOptionPane.showInputDialog("How many hours have you coded this week?"));
			 ...
			 if(numHoursCoded>=5){
				 ...
				 if(numHoursCoded<=2){
					 JOptionPane.showMessageDialog(null, "Stop watching YouTube and write your code!");
				 } else
					 if(numHoursCoded>=3){
